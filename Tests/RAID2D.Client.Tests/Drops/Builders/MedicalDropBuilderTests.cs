...
public class MedicalDropBuilderTests
{
    private readonly MedicalDropBuilder _testClass;

    public MedicalDropBuilderTests()
    {
        _testClass = new MedicalDropBuilder();
    }
    ...
    {
        // Act
        var instance = new MedicalDropBuilder();
    ...
    {
        // Arrange
        var sizeMode = PictureBoxSizeMode.Zoom;
